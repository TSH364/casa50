 ...
 * pode pedir.
 *
 * ACESSO SO DE LEITURA, e por ferramentas. A IA nao ve o banco: ela pede
 ...
 * resultado vai para o modelo. Nenhuma ferramenta escreve - entao um nome de
 * loja escrito para enganar a IA pode, no maximo, render uma resposta errada,
 * nunca uma alteracao.
 *
 ...
 * valores. E-mail, cartoes (o nome deles carrega o final), ids e anotacoes
 * livres nao saem.
 *
...
export function buildSystemPrompt(c: HouseContext): string {
  ...
  return [
    ...
    "- Você só lê. Se pedirem para mudar, apagar ou lançar algo, explique que isso se faz nas telas do app.",
